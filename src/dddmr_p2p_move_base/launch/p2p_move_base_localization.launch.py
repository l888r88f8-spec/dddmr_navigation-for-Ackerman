...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            'map_dir',
            default_value='/home/robot/map/hesai_indoor/GroundMap.pcd', # change this to your global map pcd file path
            description='Path to the global map PCD file.',
        ),
        DeclareLaunchArgument(
            'ground_dir',
            default_value='/home/robot/map/hesai_indoor/GroundMap.pcd', # change this to your ground map pcd file path
